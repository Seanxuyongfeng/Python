    ...
    def handle_starttag(self, tag, attrs):
        ...
        for attr in attrs:
            if attr[1].endswith('.html'):
                if self.flag == True:
                    self.data.append('https://www.88dushu.com/xiaoshuo/26/26122/'+str(attr[1]))
            elif attr[1] == 'mulu':
                self.flag = True
...
muluhtml = session.get("https://www.88dushu.com/xiaoshuo/26/26122/index.html")
